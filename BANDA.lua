...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ELKABOOOS/ROGEEN/main/File_Bot/commands.lua") 
...
اول شهر مجانا بعد كدا كل شهر 25ج
...
if not DevSoFi(msg) then
local Text = [[
 سعر السورس عند مارتن و الكابوس مجانا
 السيرفر الي عليك بشرط واحد السيرفر من العالمي
 لوحابب تتواصل مع المبرمجين اتبع الزر إلى تحت ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
os.execute('wget https://raw.githubusercontent.com/ELKABOOOS/ROGEEN/main/BANDA.lua')
...
if text == 'المبرمج الكابوس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[☆ 𝚠𝚎𝚕𝚌𝚘𝚖 𝚝𝚘 𝚜𝚘𝚞𝚛𝚌𝚎 𝚛𝚘𝚘𝚐𝚎𝚗](t.me/SO_ROGEN)
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝚎𝚕𝚔𝚊𝚋𝚘𝚜',url="t.me/G_W_P"},{text = '𝚊𝚕𝚖𝚊𝚐𝚔', url="t.me/M_A_G_K"}},
...
if text == 'محمد' or text == 'كابوس' or text == 'الكابوس' or text == 'توام مارتن' then
local Text = [[
مبرمج سورس روجين لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
...
if text == 'توام الكابوس' or text == 'مارتن' or text == 'مارتن التونز' or text == 'الهقر' then
local Text = [[
مبرمج سورس روجين لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
...
local Text = [[
مطور سورس روجين لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ELKABOOOS/ROGEEN/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/ELKABOOOS/ROGEEN/main/File_Bot/"..file)
if res == 200 then
...
send(msg.chat_id_,msg.id_, '[ ](t.me/SO_ROGEN)')
return false
end
end
end
